...
if __name__ == "__main__":
    ...
    np.save(f'./results/linear regression/X_p{p}_mean_exp{exp_id}', X)
    np.save(f'./results/linear regression/mean_p{p}_mean_exp{exp_id}', mean)
    np.save(f'./results/linear regression/std_p{p}_mean_exp{exp_id}', std)
    np.save(f'./results/linear regression/train_losses_p{p}_mean_exp{exp_id}', train_losses)
    np.save(f'./results/linear regression/val_losses_p{p}_mean_exp{exp_id}', val_losses)
    torch.save(model.state_dict(), f'./model/linear regression/p{p}_mean_exp{exp_id}.pt')
