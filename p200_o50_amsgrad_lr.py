...
if __name__ == "__main__":
    ...
    rng.seed(0)
    X = np.load("./data/X_rho06_N200_p200.npy")
    generator = Generator_doubleNormal_lr(X, theta, sigma0, sigma1)
    mean = np.load("./data/mean_rho06_N200_p200.npy")
    std = np.load("./data/std_rho06_N200_p200.npy")
    ...
    model = MLP_variant(N, 50, [512, 512], 'leakyrelu').to(device)
