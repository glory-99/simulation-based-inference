...
if __name__ == "__main__":
    ...
    train_losses, val_losses = train_model_with_generator(model=model,
                                                          ...
                                                          val_label=beta_val)
    end_time = time.time()
    torch.save(model.state_dict(), './model/model_rho0_tanhshrink.pt')
    np.save('./results/train_losses_rho0_tanhshrink', train_losses)
    np.save('./results/val_losses_rho0_tanhshrink', val_losses)
